...
주차: 2025-W43
최종 편집 일시: 2025년 11월 12일 오후 8:30
...
Int id;                  // PK
Int partId;
Text specJson;           // JSON 스펙 (안에 schemaVer 포함)
Bool isLinked;           // 메인 카운터와 링크 되었는지 여부
...
```dart
Int id;
Int sectionCounterId;     // sectionCounter.id (FK)
Int ord;
Int startRow;
Int rowsTotal;
Text? label;
