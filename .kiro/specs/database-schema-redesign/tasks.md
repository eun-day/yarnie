...
- [x] 5. Part 관련 데이터베이스 작업 구현
- [x] 5.1 Part CRUD 작업 구현
...
- [x] 6.4 SectionRuns 전개 로직 구현
  - _expandSectionRuns 헬퍼 메서드
  - Section spec에 따라 runs 생성
  - _Requirements: 2.3_

- [x] 7. Session 관련 데이터베이스 작업 구현
- [x] 7.1 Session CRUD 작업 구현
